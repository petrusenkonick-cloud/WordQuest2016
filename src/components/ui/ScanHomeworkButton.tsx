...
export function ScanHomeworkButton({ onClick }: ScanHomeworkButtonProps) {
  return (
    <motion.div
    ...
    >
      ...
      {/* Floating hint arrows */}
      <motion.div
        animate={{ y: [0, 5, 0] }}
        transition={{ duration: 1.5, repeat: Infinity }}
        className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[1.5em] opacity-50"
      >
